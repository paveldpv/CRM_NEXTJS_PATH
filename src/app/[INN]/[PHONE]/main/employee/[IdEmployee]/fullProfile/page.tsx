...
import { ROOT_LINK, typicalError } from '@/shared/model/types/subtypes/enums'
...
const getFullDataEmployee = async (
	INN: string,
	phone: string,
	idEmployee: string
): Promise<TDBUser | TError> => {
...
export default async function page({
	...
	params: { INN: string; PHONE: string; IdEmployee: string }
}) {
